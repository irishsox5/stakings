...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { investment_id: @relationship.investment_id, investor_id: @relationship.investor_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { investment_id: @relationship.investment_id, investor_id: @relationship.investor_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
